...
export const SEARCH_ENGINES: SearchEngine[] = [
  {
    ...
    icon: 'https://icons.guolaimoni.com/?url=www.google.com',
  },
  {
    key: 'baidu',
    name: '百度',
    template: 'https://www.baidu.com/s?wd={q}',
    icon: 'https://icons.guolaimoni.com/?url=www.baidu.com',
  },
  {
    key: 'bing',
    name: 'Bing',
    template: 'https://www.bing.com/search?q={q}',
    icon: 'https://icons.guolaimoni.com/?url=www.bing.com',
  },
  {
    key: 'duckduckgo',
    name: 'DuckDuckGo',
    template: 'https://duckduckgo.com/?q={q}',
    icon: 'https://icons.guolaimoni.com/?url=duckduckgo.com',
  },
  {
    key: 'github',
    name: 'GitHub',
    template: 'https://github.com/search?q={q}&type=repositories',
    icon: 'https://icons.guolaimoni.com/?url=github.com',
  },
  {
    key: 'bilibili',
    name: '哔哩哔哩',
    template: 'https://search.bilibili.com/all?keyword={q}',
    icon: 'https://icons.guolaimoni.com/?url=search.bilibili.com',
  },
  {
    key: 'youtube',
    name: 'YouTube',
    template: 'https://www.youtube.com/results?search_query={q}',
    icon: 'https://icons.guolaimoni.com/?url=www.youtube.com',
  },
  {
    key: 'zhihu',
    name: '知乎',
    template: 'https://www.zhihu.com/search?type=content&q={q}',
    icon: 'https://icons.guolaimoni.com/?url=www.zhihu.com',
  },
];
